...
> 공통화 ↔ 결합도). 하나의 정답은 없고 **위험·맥락에 따라 우선순위**를 정한다 — [`dev-workflow.md`의
> Working Style](../../docs/dev-workflow.md#working-style)(위험 기반 작업 원칙)과 같다. 아래는 **판단 기준이지 기계적 하드룰이 아니다** → 그래서 린트/훅으로
